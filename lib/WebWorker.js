...
function WebWorker(initParam,  // @arg Object: { origin, inline, source, script, id, verbose }
                   ...
                   callback) { // @arg Function: callback(err:Error/null, event:EventObject):void
                               // @help: WebWorker
//{@assert
    _if(!Valid.type(initParam,        "Object",        "origin,inline,source,script,id,verbose"), WebWorker, "initParam");
    _if(!Valid.type(initParam.origin, "String/omit"),  WebWorker, "origin");
    _if(!Valid.type(initParam.inline, "Boolean/omit"), WebWorker, "inline");
    _if(!Valid.type(initParam.source, "String"),       WebWorker, "source");
    _if(!Valid.type(initParam.script, "Array/omit"),   WebWorker, "script");
    _if(!Valid.type(initParam.id,     "Integer/omit"), WebWorker, "id");
    _if(!Valid.type(initParam.verbose,"Boolean/omit"), WebWorker, "verbose");
...
function WebWorker_post(requestParam,          // @arg Object: request object. { ... }
                        transferableObjects) { // @arg Array(= null): Transferable Objects.
                                               ...
                                               // @help: WebWorker#post
//{@assert
    _if(!Valid.type(requestParam,        "Object"),     WebWorker.prototype.post, "requestParam");
    _if(!Valid.type(transferableObjects, "Array/omit"), WebWorker.prototype.post, "transferableObjects");
//}@assert
